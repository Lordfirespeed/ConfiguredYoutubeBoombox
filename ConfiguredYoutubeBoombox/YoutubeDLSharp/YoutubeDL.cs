...
namespace YoutubeDLSharp
{
    ...
    public class YoutubeDL
    {
        ...
        private static readonly Regex rgxFilePostProc =
            new Regex(@"\[download\] Destination: [a-zA-Z]:\\\S+\.\S{3,}", RegexOptions.Compiled);
        ...
        public async Task<RunResult<string[]>> RunWithOptions(string[] urls, OptionSet options, CancellationToken ct)
        {
            ...
            (var code, var errors) = await runner.RunThrottled(process, urls, options, ct);
        ...
        public async Task<RunResult<string>> RunWithOptions(string url, OptionSet options,
            ...
            IProgress<DownloadProgress> progress = null, IProgress<string> output = null, bool showArgs = true)
        {
            ...
            (var code, var errors) = await runner.RunThrottled(process, new[] { url }, options, ct, progress);
            ...
            OptionSet overrideOptions = null)
        {
            ...
            (var code, var errors) = await runner.RunThrottled(process, new[] { url }, opts, ct);
            ...
            IProgress<string> output = null, OptionSet overrideOptions = null)
        {
            ...
            (var code, var errors) = await runner.RunThrottled(process, new[] { url }, opts, ct, progress);
